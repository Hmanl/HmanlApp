...
cc.Class({
    ...
    addBlock:function(){
        ...
        if(lx.language=="zh"){
            if(this.amount == 1)
            this.layout.getChildByName('followMe').getComponent(sp.Skeleton).animation = 'logo_start';
            if(this.amount == 2)
                this.layout.getChildByName('finger').getComponent(sp.Skeleton).animation = null;       
            if(this.amount == 6){
                this.lock = true;
            ...
            if(this.amount == 1)
            this.layout.getChildByName('followMe').getComponent(sp.Skeleton).animation = 'logo_start_E';
            if(this.amount == 2)
                this.layout.getChildByName('finger').getComponent(sp.Skeleton).animation = null;       
            if(this.amount == 6){
                this.lock = true;
        ...
        if(this.amount == 8)
            this.layout.getChildByName('followMe').destroy();
        if(this.amount == 15){
            this.lock = false;
    ...
    gameOver:function(){        
        ...
        this.scheduleOnce(function(){
            if(lx.language=="zh"){
                ...
                var range = Math.floor(this.score/200);
                range < 4 ? this.overPanel.getChildByName('stamp').getComponent(sp.Skeleton).animation = this.stamps_E[range]:
                this.overPanel.getChildByName('stamp').getComponent(sp.Skeleton).animation = this.stamps_E[4];   
            }                          
            this.scheduleOnce(function(){
                if(this.score>200){
    ...
    loadText(){
        this.content = [lx.i18n.t("label_text.content_1"),
        lx.i18n.t("label_text.content_2")];
        this.content2 = [
            lx.i18n.t("label_text.content2_1"),
            lx.i18n.t("label_text.content2_2"),
            lx.i18n.t("label_text.content2_3"),
            lx.i18n.t("label_text.content2_4"),
            lx.i18n.t("label_text.content2_5"),
            lx.i18n.t("label_text.content2_6"),
            lx.i18n.t("label_text.content2_7"),
            lx.i18n.t("label_text.content2_8"),
            lx.i18n.t("label_text.content2_9"),
            lx.i18n.t("label_text.content2_10"),
            lx.i18n.t("label_text.content2_11"),
            lx.i18n.t("label_text.content2_12"),
            lx.i18n.t("label_text.content2_13"),
            lx.i18n.t("label_text.content2_14"),
            lx.i18n.t("label_text.content2_15"),
            lx.i18n.t("label_text.content2_16")];
        this.content3 = [lx.i18n.t("label_text.content3_1"),lx.i18n.t("label_text.content3_2"),lx.i18n.t("label_text.content3_3"),lx.i18n.t("label_text.content3_4"),
        lx.i18n.t("label_text.content3_5")];
        this.imageUrl = ['https://h5.lexun.com/games/wx/avatar/share0.png',
                        'https://h5.lexun.com/games/wx/avatar/share1.png',];
        this.imageUrl_E=["https://h5.lexun.com/games/fb/avatar/g01.jpg",
                            "https://h5.lexun.com/games/fb/avatar/g01.jpg"];
